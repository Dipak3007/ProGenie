    ...
    <div class="container">
            ...
            <div class="signin-signup">
                <form action="Login" method="post" class="sign-in-form">
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" placeholder="Email" id="lemail" name="lemail" required />
                    </div>
                    <div class="input-field">
                    ...
                    <a href="admin-login.jsp" class="genie-sign">Sign in as Genie</a>
                </form>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <!-- <img src="https://www.indaws.es/web_editor/shape/illustration/maker-launch-svg-1941?unique=ab760200&c1=%230196A5"
                    class="image" alt="" /> -->
            </div>
